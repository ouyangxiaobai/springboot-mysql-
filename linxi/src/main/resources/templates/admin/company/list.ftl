...
<script type="text/javascript">
	...
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'photo',title:'公司图片',width:60,align:'center',formatter:function(value,row,index){
			...
			{ field:'founderPhoto',title:'创始人图片',width:60,align:'center',formatter:function(value,row,index){
				var img = '<img src=/photo/view?filename='+value+' width=50px height=50px />';
				return img;
			}},
