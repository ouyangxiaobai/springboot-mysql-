...
public class IndexController {
	...
	public String index(Model model,HttpServletRequest request){
		...
		if(user!=null){
			...
			model.addAttribute("PositionList", positionService.findPositionListContent("effective", 0, 20,degree));//获取20个职位列表
			model.addAttribute("PositionTotal", positionService.getPositionTotalContent("effective",degree));
		}else{
