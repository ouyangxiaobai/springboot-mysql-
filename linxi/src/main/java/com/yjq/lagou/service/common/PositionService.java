...
public class PositionService {
	...
	public int getPositionTotalContent(String state,String degree){
		return positionDao.getPositionTotalContent(state,degree);
	}
	...
	public List<Position> findPositionListContent(String state,int offset,int pageSize,String degree)
	{
		return positionDao.findPositionListContent(state, offset, pageSize,degree);
	}
